...
Normal.Text = "2" -- This is "tombol 2"
...
userInputService.InputBegan:Connect(function(input, gameProcessedEvent)
    -- Check if the 'E' key was pressed and it wasn't processed by Roblox's internal systems (like typing in a chat box)
    if input.KeyCode == Enum.KeyCode.E and not gameProcessedEvent then
        -- Simulate a click on the "Normal" button (tombol 2)
        Normal:Activated:Fire()
    end
end)
-- END OF NEW SECTION
